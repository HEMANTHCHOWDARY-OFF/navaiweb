      ...
      <div className="p-6 md:p-8">
        ...
        {generatedQuestions.length > 0 && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Generated Questions</h2>
            <div id="generated-questions-content" className="space-y-4">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="bg-primary-blue text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors flex items-center space-x-2"
                >
