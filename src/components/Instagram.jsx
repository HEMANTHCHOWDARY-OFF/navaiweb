    ...
    <main className="flex-1 pt-16 ml-0 md:ml-64">
      <div className="p-6 md:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">Stay connected for the latest career tips, app updates, AI insights, and user success stories.</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mt-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Stay connected for the latest career tips, app updates, AI insights, and user success
              stories. Our Instagram page inspires, educates, and engages you in your career journey
              while maximizing NavAI's AI-powered tools to help you achieve your professional goals.
            </p>
          </div>
