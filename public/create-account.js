...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleAccountCreation(data) {
        // Show loading state
        ...
        setTimeout(() => {
            ...
            // Store user data in localStorage to maintain consistency with React app
            const userData = {
                email: data.email,
                name: data.fullName,
            ...
            // Redirect to React application on the dev server
